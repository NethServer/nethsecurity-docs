...
- `Custom DNS Servers`: If you need to define **custom DNS resolvers for specific domains**, you can configure them here. The syntax is the same used in the DNS section of NethSecurity. For reference, see [domain-specific DNS servers](../network/dns_dhcp.md#domain-specific-dns-servers).
